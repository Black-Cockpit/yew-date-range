...
fn test_is_date_disabled_min() {
    ...
    assert!(RangeHelper::is_date_disabled(
        d,
...
fn test_is_date_disabled_with_weekdays() {
    ...
    assert!(RangeHelper::is_date_disabled_with_weekdays(
        sunday,
        None,
        None,
        &[],
...
fn test_is_range_selected() {
    let a = RangeSelection::new("s").with_dates(Some(date!(2024 - 01 - 01)), Some(date!(2024 - 01 - 31)));
    let b = RangeSelection::new("s").with_dates(Some(date!(2024 - 01 - 01)), Some(date!(2024 - 01 - 31)));
    let c = RangeSelection::new("s").with_dates(Some(date!(2024 - 02 - 01)), Some(date!(2024 - 02 - 28)));
...
fn test_compute_preview_not_selecting() {
    let ranges = vec![RangeSelection::new("s").with_dates(Some(date!(2024 - 01 - 10)), Some(date!(2024 - 01 - 20)))];
...
fn test_is_span_valid_no_constraints() {
    assert!(RangeHelper::is_span_valid(
        date!(2024 - 01 - 01),
        date!(2024 - 12 - 31),
        None,
        None
...
fn test_find_focused_range_found() {
    let ranges = vec![
        RangeSelection {
            auto_focus: false,
            disabled: false,
            ..RangeSelection::new("a")
        },
        RangeSelection {
            auto_focus: true,
            disabled: false,
            ..RangeSelection::new("b")
        },
    ];
